  ...
  return (
    <Layout>
      ...
      {recipe.equipment && recipe.equipment.length > 0 && (
        <div className="section-container bg-chang-neutral-100">
          <div className="content-container">
            <div className="max-w-4xl mx-auto">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-chang-brown-700 mb-6 flex items-center">
                  <svg className="w-6 h-6 mr-3 text-chang-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {recipe.equipment.map((item: string, index: number) => (
                    <div key={index} className="flex items-center text-chang-brown-600">
                      <svg className="w-4 h-4 mr-2 text-chang-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {recipe.notes && (
        <div className="section-container">
          <div className="content-container">
            <div className="max-w-4xl mx-auto">
              <div className="bg-gradient-to-r from-chang-orange-50 to-chang-orange-100 rounded-2xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-chang-brown-700 mb-6 flex items-center">
                  <svg className="w-6 h-6 mr-3 text-chang-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="prose prose-chang max-w-none">
                  <p className="text-chang-brown-700 leading-relaxed text-lg whitespace-pre-line">
                    {recipe.notes}
                  </p>
                </div>
              </div>
